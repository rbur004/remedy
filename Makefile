...
target_prefix = 
LOCAL_LIBS = 
LIBS = $(LIBRUBYARG_SHARED) -lar  -lpthread -ldl -lm  
SRCS = ar_bulk_entry.c ar_class.c ar_status_list.c ar_valueStructClass.c
OBJS = ar_bulk_entry.o ar_class.o ar_status_list.o ar_valueStructClass.o
TARGET = tmpfile
DLLIB = $(TARGET).bundle
EXTSTATIC = 
STATIC_LIB = 
